...
int scheduler::getNextProcess(int time){
...
int main()
{
    ...
    while(ch!=3)
    {
        cout<<"Press 1.Round Robin\nPress 2.Shortest Remaining time\n";
        cin>>ch;
        switch(ch)
        {
            case 1: s.computeRR(); break;
            case 2: s.computeSRT(); break;
